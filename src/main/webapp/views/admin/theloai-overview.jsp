            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/OverViewCategory" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Xem Thể Loại</p>
                                </a>
                            </li>
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="sortId" class="form-control" onchange="sortCategory()">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" id="keywords" class="form-control" onkeyup="searchCategory()" placeholder="Tìm kiếm...">
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>${item.name}</td>
                                    <td>
                                        <a type="button" role="button" href="/admin/AddCategory/edit/${item.id}" class="btn btn-warning mr-2">Chỉnh sửa</a>
                                        <a type="button" role="button" href="/admin/OverViewCategory/delete/${item.id}" class="btn btn-danger">Xóa</a>
                                    </td>
                                </tr>
                                </c:forEach>
                            </table>
                    ...
                    success: function(categories) {
                        ...
                        categories.forEach(function(item) {
                            var row = '<tr>' +
                                '<th scope="row">' + item.id + '</th>' +
                                '<td>' + item.name + '</td>' +
                                '<td><a type="button" class="btn btn-warning mr-2" href="/admin/AddCategory/edit/' + item.id + '">Chỉnh sửa</a>' +
                                '<a type="button" class="btn btn-danger" href="/admin/OverViewCategory/delete/' + item.id + '">Xóa</a></td>' +
                                '</tr>';
