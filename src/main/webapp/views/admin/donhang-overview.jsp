    ...
    <div class="content-wrapper">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="sortId" class="form-control" onchange="sortOrders()">
                                <option value="id-ASC">ID Tăng</option>
                                <option value="id-DESC">ID Giảm</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <label for="sortSuppliers">Lọc Trạng Thái:</label>
                            <select id="sortSuppliers" class="form-control" onchange="sortOrder()">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="keywords" name="keywords" onkeyup="searchOrders()">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach var="order" items="${orders}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/edit/${order.id}" class="btn btn-sm btn-warning mr-2">Chi tiết</a>
                                                    <a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/done/${order.id}" class="btn btn-sm btn-success mr-2">Xác Nhận</a>
                                                    <a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/Canceled/${order.id}" class="btn btn-sm btn-danger mr-2">Hủy</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
        ...
        <script>
            function sortOrders() {
                ...
                if (sortId) {
                    sortField = sortId.split('-')[0];
                    sortDir = sortId.split('-')[1];
                }

                $.ajax({
                    url: '/admin/xulydonhang/sortOrders',
                    type: 'GET',
                    data: {
                        sortField: sortField,
                        sortDir: sortDir,
                        status: sortSuppliers
                    },
                    success: function(orders) {
                        ...
                        orders.forEach(function(order) {
                            ...
                            if (order.orderstatus === 'Waiting') {
                                row += '<a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/edit/' + order.id + '" class="btn btn-sm btn-warning mr-2">Chi tiết</a>' +
                                    '<a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/done/' + order.id + '" class="btn btn-sm btn-success mr-2">Xác Nhận</a>' +
                                    '<a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/Canceled/' + order.id + '" class="btn btn-sm btn-danger mr-2">Hủy</a>';
                            } else {
                                row += '<a type="button" role="button" href="/admin/xulydonhang/OverviewOrder/edit/' + order.id + '" class="btn btn-sm btn-warning mr-2">Chi tiết</a>';
            ...
            function searchOrders() {
                ...
                $.ajax({
                    url: '/admin/xulydonhang/searchOrder',
                    type: 'GET',
            ...
            $(document).ready(function() {
                $('#sortId').change(sortOrders);
                $('#sortSuppliers').change(sortOrders);
            });
        </script>
