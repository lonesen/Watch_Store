...
<%--                <div class="row">--%>
<%--                    <div class="col-md-12">--%>
<%--                        <form action="/admin/AddProduct/create" method="post" enctype="multipart/form-data">--%>
<%--                            <div class="row">--%>
<%--                                <div class="col-md-12">--%>
...
<%--                                            </div>--%>
<%--                                            <div class="form-group">--%>
<%--                                                <label for="photo_file" class="form-label">File:</label>--%>
<%--                                                <input name="photo_file" type="file" accept="image/*" class="form-control" id="photo_file" onchange="previewImage(event)"/>--%>
...
<%--                                    <button type="reset" id="resetBtn" class="btn bg-gradient-info btn-md" style="margin-right: 15px;">Reset</button>--%>
<%--                                    <button type="submit" id="submitBtn" class="btn bg-gradient-success btn-md">Submit</button>--%>
<%--                                </div>--%>
...
<%--        </script>--%>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="<c:if test="${isEdit}">/admin/AddProduct/update</c:if>
                            <c:if test="${!isEdit}">/admin/AddProduct/create</c:if>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="id">Mã Sản Phẩm</label>
                                                <input type="text" id="id" name="id" class="form-control" value="${product.id}" <c:if test="${isEdit}">readonly</c:if> >
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Tên Sản Phẩm</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="preview">Preview:</label>
                                                    <img id="imgPreview" src="<c:if test="${product.image != null}">/img/${product.image}</c:if>" alt="Image Preview" style="display: <c:if test="${product.image != null}">block</c:if>;<c:if test="${product.image == null}">none</c:if>; width: 200px; height: auto;"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="category">Thể Loại</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="supplier" name="supplier" class="form-control">
                                                    <c:forEach var="item" items="${supplier}" varStatus="loop">
                                                        <option value="${item.id}" ${item.id == product.supplier.id ? 'selected' : ''}>${item.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <!-- Hidden field for activated -->
