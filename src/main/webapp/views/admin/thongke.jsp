                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Thống kê sản phẩm đã bán </h3>
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach items="${thongKeList}" var="result">
                                                    <tr>
                                                        <td>${result[0]}</td>
                                                        <td>${result[1]}</td>
                                                        <td>${result[2]}</td>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Top 3 sản phẩm mà giới tính Nữ mua nhiều nhất</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                        ...
                                        <div class="card-body">
                                            <table id="example3" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach items="${thongKeSanPhamGioiTinhTrue}" var="item">
                                                    <tr>
                                                        <td>${item[0]}</td>
                                                        <td>${item[1]}</td>
                                                        <td>${item[2]}</td>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title"> Top 3 sản phẩm mà giới tính Nam mua nhiều nhất</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                        ...
                                        <div class="card-body">
                                            <table id="example4" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach items="${thongKeSanPhamGioiTinhFalse}" var="item">
                                                    <tr>
                                                        <td>${item[0]}</td>
                                                        <td>${item[1]}</td>
                                                        <td>${item[2]}</td>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Top 3 Thể Loại Sản Phẩm Bán Nhiều Nhất</h3>
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="example2" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                <c:forEach items="${thongkeTop3TheLoai}" var="item">
                                                    <tr>
                                                        <td>${item[0]}</td>
                                                        <td>${item[1]}</td>
                                                    </tr>
...
<%--        </script>--%>
        <script>
            document.addEventListener('DOMContentLoaded', (event) => {
                ...
                const thongkeTop3TheLoai = [
                    <c:forEach items="${thongkeTop3TheLoai}" var="item">
                    { category: '${item[0]}', totalSold: ${item[1]} },
                    </c:forEach>
                ];

                // Prepare data for the chart
                const labels = thongkeTop3TheLoai.map(item => item.category);
                const data = thongkeTop3TheLoai.map(item => item.totalSold);
