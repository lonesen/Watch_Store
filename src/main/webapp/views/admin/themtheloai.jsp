    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <form action="/admin/AddCategory/save" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Thêm & chỉnh sửa thể loại</h3>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="id" name="id" class="form-control" value="${category.id}" readonly>
                                            </div>
                                            <div class="form-group">
