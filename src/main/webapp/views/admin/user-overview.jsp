            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <label for="sortCategory">Sắp xếp Giới tính:</label>
                        ...
                        <div class="col-md-2">
                            <label for="sortSuppliers">Sắp xếp Theo Role:</label>
                        ...
                        <div class="col-md-1">
                            <label for="sortPrice">Sắp xếp trạng thái:</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <a type="button" role="button" href="/admin/OverViewProduct/delete/${item.id}" class="btn btn-sm btn-danger">Hủy Trạng Thái</a>
                                        </div>
                                    </td>
                                </tr>
                                </c:forEach>
