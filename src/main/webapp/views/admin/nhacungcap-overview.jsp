    ...
    <div class="content-wrapper">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="sortId" class="form-control" onchange="sortSupplier()">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="keywords" name="keywords" onkeyup="searchSupplier()">
                                    </div>
                                    <div class="col-sm-2">
                                        <button type="button" class="btn btn-primary" onclick="searchSupplier()">Search</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <c:forEach var="item" items="${supplier}" varStatus="loop">
                                    <tr>
                                        ...
                                        <td>${item.address}</td>
                                        <td>
                                            <a type="button" role="button" href="/admin/AddSupplier/edit/${item.id}" class="btn btn-warning mr-2">Chỉnh sửa</a>
                                            <a type="button" role="button" href="/admin/OverViewSupplier/delete/${item.id}" class="btn btn-danger">Xóa</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
        ...
        <script>
            function sortSupplier() {
                ...
                // Split the sort value to get the field and direction
                var sortField1, sortDir1;
                    ...
                    success: function(suppliers) {
                        ...
                        suppliers.forEach(function(item) {
                            var row = '<tr>' +
                                ...
                                '<td>' + item.name + '</td>' +
                                '<td>' + item.address + '</td>' +
                                '<td><a type="button" class="btn btn-warning mr-2" href="/admin/AddSupplier/edit/' + item.id + '">Chỉnh sửa</a>' +
                                '<a type="button" class="btn btn-danger" href="/admin/OverViewSupplier/delete/' + item.id + '">Xóa</a></td>' +
                                '</tr>';
                            tableBody.append(row);
                        });
                    },
                    error: function() {
                        alert('Error retrieving sorted Supplier');
                    }
                });
            }
            ...
            function searchSupplier() {
                ...
                $.ajax({
                    ...
                    error: function() {
                        alert('Error retrieving suppliers');
                    }
                });
            }
